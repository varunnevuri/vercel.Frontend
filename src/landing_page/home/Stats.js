        ...
        <div className='container p-5'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                 ...
                 <p className='text-muted'>No gimmicks ,spams,"gamification" or annoying push notifications.High quality apps
                  taht you use at your pace ,the way you like.
                 </p>
                 ...
                 <p className='text-muted'>with initiatives like Nudge and kill Switch,we dont just facilitate transactions but activeky help you do Better with your money 
                 </p>
                </div>
               <div className='col-6 p-5'>
